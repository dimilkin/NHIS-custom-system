...
public class MessageX001V3 implements Serializable {
    ...
    protected ContentsX001V3 contents;
    ...
    public ContentsX001V3 getContents() {
        return contents;
    }

    public void setContents(ContentsX001V3 contents) {
